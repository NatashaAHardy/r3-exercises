...
1) specify a directory like infographiq-project inside your r3-exercises folder; and 

2) tick Open in a new session; before clicking Create Project:

Note that we'll be using a parameterised Rmarkdown with params > 'svg' and 'csv'

RStudio should open to a new session with the Source and Files panes.
